...
def main():
    ...
    n_bins = 652 # predict at precision of .01 micro volt
    ...
    rnn_units = 2048 # hyperparams to be tuned
    embedding_dim = 512 # hyperparams to be tuned
    ...
    best_weight_file = "./training_checkpoints_2/best_loss_epoch_731"
    # evaluate model
    ...
    for i in range(1000):
        ...
        y_hat = predict(X_batch, model)
        y_pred_list.append(y_hat)
    print("y_truth_list: ", y_truth_list)
    print("y_pred_list: ", y_pred_list)
    print("mean_squared_error: ", mean_squared_error(y_truth_list, y_pred_list))
